...
<section class="content">
    <div class="box box-default collapsed-box">
        <div class="box-header with-border">
            <h3 class="box-title">Nama Manusia</h3>
            <div class="box-tools pull-right">
                <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-plus"></i></button>
            </div><!-- /.box-tools -->
        </div><!-- /.box-header -->
        <div class="box-body">
            Demi menamatkan Mata Kuliah Basdat
            <ol>
                        <li>Farhan Nurrohman</li>
                        <li>Made Althaaf Naufal Gusendra</li>
                        <li>Halida Fiadnin</li>
                    </ol>
        </div><!-- /.box-body -->
    </div><!-- /.box -->

    <!--GAGUNA GAUSAH DI APA APAIN
	...
	<div class="callout callout-info">
    	<h4>Informasi</h4>
        <p>Ini adalah area administratif W-Do, yang memiliki sangat friendlt tapi menyusahkan peserta didik dalam menjawab karena soalnya ga ngotak bat.</p>
    </div>
    <div class="box">
        <div class="box-header with-border">

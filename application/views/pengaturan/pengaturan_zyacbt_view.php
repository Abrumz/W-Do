...
<section class="content-header">
	<h1>
		Pengaturan W-Do
		<small>Melakukan pengaturan Identitas W-Do</small>
	</h1>
	<ol class="breadcrumb">
		<li><a href="<?php echo site_url(); ?>/"><i class="fa fa-dashboard"></i> Home</a></li>
		<li class="active">Pengaturan W-Do</li>
	</ol>
</section>
			...
			<?php echo form_open($url.'/simpan','id="form-pengaturan"'); ?>
                <div class="box">
                    <div class="box-header with-border">
    					<div class="box-title">Daftar Pengaturan W-Do</div>
                    </div><!-- /.box-header -->
                    ...
                    <div class="box-body form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                <p class="help-block">
									Nama Pelaksana W-Do.<br />
                                    Digunakan sebagai tugas akhir Basis Data.
								</p>
							</div>
						</div>
						<div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                <p class="help-block">
									Keterangan Pelaksana bisa diisi dengan Slogan seperti hoyeah.
								</p>
							</div>
						</div>
						<div class="form-group">

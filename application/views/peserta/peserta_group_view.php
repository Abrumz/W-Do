...
<section class="content-header">
	<h1>
		Grup
		<small>Daftar grup, penambahan grup, pengubahan grup, dan penghapusan grup</small>
	</h1>
	<ol class="breadcrumb">
        ...
        <div class="col-md-12">
                <div class="box">
                    <div class="box-header with-border">
    						<div class="box-title">Daftar Grup</div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <div id="trx-judul">Tambah Grup</div>
                </div>
                <div class="modal-body">
                    <div class="row-fluid">
                        <div class="box-body">
                            ...
                            <p>NB : Grup digunakan untuk mengelompokkan setiap user</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-body">
                    <div class="row-fluid">
                        <div class="box-body">
                            ...
                            <p>NB : Grup yang dihapus, maka semua data user akan ikut terhapus !</p>
                        </div>
                    </div>
                </div>
                <div class="modal-footer">

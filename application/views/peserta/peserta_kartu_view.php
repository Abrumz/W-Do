	...
	<div class="row">
        <div class="col-md-12">
            <div class="callout callout-info">
                <h4>Informasi</h4>
                <p>Lakukan Pengaturan nama pelaksana W-Do sebelum mencetak kartu peserta agar kartu sesuai dengan Organisasi tempat anda melaksanakan Tes.</p>
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <div class="form-group col-sm-6">
                            ...
                            <p class="help-block">Pilih Data Grup Peserta yang akan di cetak</p>
                        </div>
